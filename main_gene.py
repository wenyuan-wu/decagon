...
for u, v in zip(stitch_list, gene_list):
    ...
    # gene_list_temp.append(v)

print(len(gene_list_temp), " gene_list_temp")
print(len(gene_idx_list), "gene_idx_list")
# print(gene_idx_list)
# print(drug_idx_list)
# print(data_list)
# print(gene_idx_list.sort())
print(gene_idx_list[:5])
...
print(gene1_list == gene2_list)

gene1_list_new, gene2_list_new = [], []
for i, j in tqdm(zip(gene1_list, gene2_list)):
    # print(i)
    # print(j)

    if i in gene_list and j in gene_list:
        gene1_list_new.append(i)
        gene2_list_new.append(j)

print("!"*40)
print(len(gene1_list_new))
print(len(gene2_list_new))
print(len(gene_list))

print(len(gene1_list))
print(len(gene2_list))
print("HERE!")
data_list, gene_idx1_list, gene_idx2_list = [], [], []
for u, v in zip(gene1_list_new, gene2_list_new):
